...
export default function ProfilePage() {
  ...
  const togglePostVisibility = async () => {
    ...
    try {
      ...
      // Update local state
      setProfile((prev) =>
        prev ? { ...prev, showPostsToPublic: newValue } : null
      );
    } catch (error) {
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          ...
                          {profile?.joinDate?.toDate
                            ? profile.joinDate.toDate().toLocaleDateString()
                            : "Recently"}
                        </span>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-gray-900 text-sm">
                          Show posts to visitors
                        </h4>
                        <p className="text-xs text-gray-600">
                          {profile?.showPostsToPublic
                            ? "Your posts are visible to mutual mesh members"
                            : "Your posts are completely private"}
                        </p>
                      </div>
                      <button
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        {userCommunities.map((community) => (
                          <div
                            ...
                            onClick={() =>
                              router.push(
                                `/community/${community.id}?returnTo=/profile`
                              )
                            }
                          >
